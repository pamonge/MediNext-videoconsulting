...
class PostgresDsn(_BaseMultiHostUrl):
    ...
    * Supports multiple hosts
    ...
    m = MyDatabaseModel(db='postgres://user:pass@localhost:5433/foobar')
    print(m.db)
    #> postgres://user:pass@localhost:5433/foobar

    try:
        MyDatabaseModel(db='postgres://user:pass@localhost:5433')
    except ValidationError as e:
        print(e)
        '''
        ...
        assert (None)
         +  where None = PostgresDsn('postgres://user:pass@localhost:5433').path [type=assertion_error, input_value='postgres://user:pass@localhost:5433', input_type=str]
        '''
    ```
    """
